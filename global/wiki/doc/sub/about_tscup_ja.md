...
<div class="wikitag-attention">
    <div class="wikitag-titlewrapper">
        ...
        <div class="wikitag-title">免責事項:</div>
    </div>
...
<div class="wikitag-attention">
    ...
    <div class="wikitag-content">このページはまだ翻訳されていません。<br>翻訳が必要な場合は、ブラウザの翻訳機能を使用するか、信頼できる翻訳プラットフォームを使用してください。<br>あなたは翻訳者ですか？もしそうなら、電子メールであなたの文書の翻訳を私たちのサイトに反映できるかどうかお問い合わせください。</div>
</div>
...
本サイトの世界観プロジェクト文書はいつでも修正できる揮発性文書であり、正式オープンという概念は存在しません。いつでも公開、編集、削除されることがあります。このサイトは個々の文書のリビジョン履歴閲覧機能をサポートしていません。いつ、どの文書が変更されたかを確認するには、ページ下部のコミット履歴をクリックしてサイトの変更を参照してください。
