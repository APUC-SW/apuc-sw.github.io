...
この記事を見ているなら、あなたはおそらく開発者ツールなどの迂回的な方法で入ってきた人でしょう。それとも本当に幸運に私の認証サーバーが正常に動作したか。おそらく後者である可能性はほとんどありません。なぜなら、私の外部サーバーの依存関係を最小限に抑えるために、ほとんどのサーバーサイド機能は私のサイトでは基本的には機能しないからです。
