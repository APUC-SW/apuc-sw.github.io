...
이 글을 보고 계시다면 아마도 개발자 도구 등의 우회적인 방식으로 들어오신 분일 겁니다. 아니면 정말 운이 좋게 제 인증 서버가 정상 작동했거나요. 아마도 후자일 가능성은 거의 없을 겁니다. 왜냐하면 저의 외부 서버 의존성을 최소화하려는 노력 때문에 대부분의 서버사이드 기능은 제 사이트에서는 기본적으로 동작하지 않기 때문입니다.
